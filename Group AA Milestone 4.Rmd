...
Of those who do have health outcomes, how are they distributed by income status. 
How about those that do not have health outcomes? How are they distributed by income. 
```{r}
library(ggplot2)
