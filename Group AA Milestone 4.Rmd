...
A<- ggplot(data = na.omit(asthma_by_income), aes(x = new_asthma, y= asthma_count)) +
  geom_bar(aes(fill = income_levels), stat = "identity", position = position_dodge()) +
    scale_fill_discrete(name = "Income Level") + labs(x= "Asthama Status", y = "# of Patients", title = "Patients and Their Asthma Status Distributed by Income Status", caption = "Note: Patients who did not respond were excluded")
```
\newpage
...
B <- ggplot(data = heartdis_by_income, aes(x = new_heartdis, y= heartdis_count)) +
  geom_bar(aes(fill = income_levels), stat = "identity", position = position_dodge()) +
  scale_fill_discrete(name = "Income Level") + labs(x= "Heart Disease Status", y = "# of Patients", title = "Patients and Their Heart Disease Status Distributed by Income Status", caption = "Note: Patients who did not respond were excluded")
...
C<- ggplot(data = diabetes_by_income, aes(x = new_diabetes, y= diabetes_count)) +
  ...
  scale_fill_manual(values=c("#9933FF",
                             "#33FFFF",
                             "red"), name = "Income Level") + labs(x= "Diabetes Status", y = "# of Patients", title = "Patients and Their Diabetes Status Distributed by Income Status", caption = "Note: Patients who did not respond were excluded")
